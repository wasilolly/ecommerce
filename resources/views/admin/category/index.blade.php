...
@section('content')
                    ...
                    <table class="w-full whitespace-no-wrap">
                        <thead>
                            <tr
                                ...
                                <th class="px-1 py-3">No. of Products</th>
                            ...
                            @foreach ($categories as $category)
                                <tr class="text-gray-700 dark:text-gray-400">
                                    ...
                                    <td class="px-4 py-3 text-sm">
                                       <a href="{{ route('category.show', ['category' => $category]) }}">View &RightArrow;</a> 
                                    </td>
                                </tr>
                            @endforeach
    ...
    <div x-show="isModalOpen" x-transition:enter="transition ease-out duration-150" x-transition:enter-start="opacity-0"
        ...
        <div x-show="isModalOpen" x-transition:enter="transition ease-out duration-150"
            ...
            <div class="mt-4 mb-6">
                <!-- Modal title -->
                <p class="mb-2 text-lg font-semibold text-gray-700 dark:text-purple-300">Create a new Category</p>
                <!-- Modal description -->
                <form action="{{ route('category.store') }}" method="post">
                    ...
                    <div>
                        ...
                        <textarea class="block mt-1 w-full" name="description" cols="30" rows="10" required
