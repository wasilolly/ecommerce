...
<div class="container mx-auto px-6">
    ...
    <div class="md:flex md:items-center">
        ...
        <div class="w-full max-w-lg mx-auto mt-5 md:ml-8 md:mt-0 md:w-1/2">
            ...
            <hr class="my-3">
            <div class="mt-2">
                <label class="text-gray-700 text-sm font-bold" for="count">Count:</label>
            ...
            <hr class="my-3">
            <div class="mt-3">
                <label class="text-gray-700 text-m font-bold" for="count">Description</label>
                <div class="flex items-center mt-1">
                   {{$product->description}}
                </div>
            </div>
            <div class="flex items-center mt-6">
                <button class="px-8 py-2 bg-purple-600 text-white text-sm font-medium rounded hover:bg-purple-500 focus:outline-none focus:bg-purple-500">Order Now</button>
